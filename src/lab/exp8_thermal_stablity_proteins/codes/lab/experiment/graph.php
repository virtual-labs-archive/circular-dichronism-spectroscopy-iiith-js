...
<script class='gtm'>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-W59SWTR');</script>
 ...
 function plotStartTemp(temp){
	...
	var plot =  $.plot($("#placeholder"), 
			[ {label: "MRE Vs &lambda;(in nm)<br> At Temperature: <span style='font-size:20px;'> "+temp+" </span>", data: d1, color: "red"} ],
 ...
 function genAnalysis(flag){
	...
	if(flag == 0){
		var plot =  $.plot($("#placeholder"), 
				[ 
					{label: "Temperature Vs MRE values at 222 nm selected by you", data: analysisData, points:{show:true}, lines:{show:false}, color:"red"}, 
					{label: "Temperature Vs MRE values at 222 nm acctually recorded", data: d1, points:{show:true}, lines:{show:false}, color: "green"}
				],
				{ grid: { hoverable: true, clickable: true },
		...
		var plot =  $.plot($("#placeholder"), 
				[ 
					{label: "Temperature Vs %Helicity", data: d3, points:{show:true}, lines:{show:false}, color:"red"} 
				],
				{ grid: { hoverable: true, clickable: true },
		  		  yaxis:{min: 20, max: 55}
      				}
...
.boundingBox{	
 ...
 <body>
	...
	<ul>
	  ...
	  <li>Click on Analysis to see the change of parameter with temperature</li>
	</ul>
	...
	<center><br><br>
	<tr><center><button class="boundingBox" onclick='window.location="post_exp_quiz.php";'>Go To Analysis</button></center> 
</tr>
	</center>
      </div>
