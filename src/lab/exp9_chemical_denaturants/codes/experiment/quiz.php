...
<div id="content">
  ...
  <tr><td width=70%>
    <li>
	 1.In the animation protein at which temperature starts unfolding the first?
      <ol type="A">
...
<br>	<?php 
  ...
  <tr><td>
    <li>
	 2.From the readings of CD spectrum at 222nm we can have information about which secondary structure?
      <ol type="A">
	 ...
	 <li><input type="radio" name="q2" value="D">Coli</li>
      </ol>
    </li><br>
	<?php 
	if($_POST){
  ...
  <tr><td>
     <li>
	 2.How does the plot of  MRE values at 222 nm with temperature looks like?
      <ol type="A">
	 <li><input type="radio" name="q3" value="A">Linear</li>
	 <li><input type="radio" name="q3" value="B">Sigmoidal</li>
  ...
  <tr><td>
    <li>
	 What is the trend of change of % helicity in Rhodopsin with temperature?
      <ol type="A">
	 <li><input type="radio" name="q4" value="A">Does not change at all.</li>
